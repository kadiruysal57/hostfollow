...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        index: DrawerIndex.DailyList,
        labelName: 'Günlük Program',
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network("https://ui-avatars.com/api/?name=kadir+uysal&color=ffffff&background=1476d2&size=120"),
                            ),
                          ),
                        ),
                      );
